...
public struct HoudiniVersion
{
	...
	public const string HAPI_SERVER			= "/Applications/Houdini/Houdini16.5.536/Frameworks/Houdini.framework/Versions/16.5.536/Resources/bin/" + "HARS";
	#if UNITY_EDITOR_64 || UNITY_64
		public const string HAPI_LIBRARY	= "/Applications/Houdini/Houdini16.5.536/Frameworks/Houdini.framework/Versions/16.5.536/Libraries/" + "libHARC.dylib";
	#else
		public const string HAPI_LIBRARY	= "/Applications/Houdini/Houdini16.5.536/Frameworks/Houdini.framework/Versions/16.5.536/Libraries/" + "libHARC32.dylib";
	#endif // UNITY_EDITOR_64

#elif UNITY_STANDALONE_LINUX

	public const string HAPI_SERVER			= "/opt/hfs16.5.536/bin/" + "HARS";
	public const string HAPI_LIBRARY		= "/opt/hfs16.5.536/dsolib/" + "libHARC.so";
